...
import arc.math.Matrix4;
import arc.math.Matrix3;
import arc.math.MathUtils;
import arc.math.Quaternion;
...
public class Matrix4 implements Serializable {
	 ...
	 * the same as {@link Vec3#mul(Matrix4)} applied to multiple vectors.
	 * 
	 * @param mat the matrix
	 ...
	 * subsequent vectors and must be >= 3. This is the same as {@link Vec3#prj(Matrix4)} applied to multiple vectors.
	 * 
	 * @param mat the matrix
	 * @param vecs the vectors
	 * @param offset the offset into the vectors array
	 ...
	 * is the same as {@link Vec3#rot(Matrix4)}.
	 * @param mat the matrix
	 * @param vec the vector. */
	 ...
	 * Offset specifies the offset into the array where the x-component of the first vector is located. The numVecs parameter
	 * specifies the number of vectors stored in the vectors array. The stride parameter specifies the number of floats between
	 * subsequent vectors and must be >= 3. This is the same as {@link Vec3#rot(Matrix4)} applied to multiple vectors.
	 * 
	 * @param mat the matrix
	 * @param vecs the vectors
	 * @param offset the offset into the vectors array
	 ...
	 * @param up up vector
	 * @return This matrix for chaining */
	public Matrix4 rotateTowardDirection (final Vec3 direction, final Vec3 up) {
		l_vez.set(direction).nor();
	 ...
	 * @param up the up vector
	 * @return This matrix for chaining */
	public Matrix4 rotateTowardTarget (final Vec3 target, final Vec3 up) {
