...
public class Quaternion implements Serializable {
    ...
    public Quaternion setEulerAngles (float yaw, float pitch, float roll) {
        return setEulerAnglesRad(yaw * MathUtils.degreesToRadians, pitch * MathUtils.degreesToRadians,
                roll * arc.math.MathUtils.degreesToRadians);
    }
    ...
    public float getRollRad () {
        ...
        return pole == 0 ? arc.math.MathUtils.atan2(2f * (w * z + y * x), 1f - 2f * (x * x + z * z))
...
// value
    ...
    /** Get the angle in degrees of the rotation this quaternion represents. Use {@link #getAxisAngle(Vec3)} to get both the
