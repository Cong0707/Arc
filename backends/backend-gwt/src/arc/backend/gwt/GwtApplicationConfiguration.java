...
public class GwtApplicationConfiguration {
	/** If true, audio backend will not be used. This means {@link arc.Application} returns null. */
	 ...
	 * 3.0 is enabled, {@link arc.Core#gl30} can be used to access its functionality. */
