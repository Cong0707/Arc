...
public class GwtGL30 extends GwtGL20 implements GL30 {
	...
	public void glGetActiveUniformBlockiv (int program, int uniformBlockIndex, int pname, IntBuffer params) {
		if (pname == GL30.GL_UNIFORM_BLOCK_BINDING || pname == GL30.GL_UNIFORM_BLOCK_DATA_SIZE
			...
			throw new ArcRuntimeException("Unsupported pname passed to glGetActiveUniformBlockiv");
		}
		params.flip();
	}
	...
	public void glGetQueryObjectuiv (int id, int pname, IntBuffer params) {
		...
		if (pname == GL30.GL_QUERY_RESULT) {
			...
			throw new ArcRuntimeException("Unsupported pname passed to glGetQueryObjectuiv");
		}
		params.flip();
	}
