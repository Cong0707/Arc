...
public class WebAudioAPIMusic extends Music {
	...
	private ApplicationListener onCompletionListener;
	...
	public void ended () {
		if (this.onCompletionListener != null) this.onCompletionListener.dispose();
	}
	...
	public void setOnCompletionListener (ApplicationListener listener) {
