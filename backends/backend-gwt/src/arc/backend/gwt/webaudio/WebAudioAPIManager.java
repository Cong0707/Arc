...
package arc.backend.gwt.webaudio;
...
import arc.backend.gwt.preloader.AssetDownloader;
import arc.files.Fi;
import arc.util.Log;
...
public class WebAudioAPIManager implements ApplicationListener {
	...
	public void setUnlocked () {
		Log.infoTag("Webaudio", "Audiocontext unlocked");
		soundUnlocked = true;
	}
	...
	public Music createMusic (Fi fileHandle) {
		String url = ((GwtFi)fileHandle).getAssetUrl();
