...
public class GwtGraphics extends Graphics {
	...
	public GwtMonitor getPrimaryMonitor () {
		return new GwtMonitor(0, 0, "Primary Monitor");
	}

	public GwtMonitor getMonitor () {
		return getPrimaryMonitor();
	}

	public GwtMonitor[] getMonitors () {
		return new GwtMonitor[] {getPrimaryMonitor()};
	}
