...
public class GwtGL20 implements GL20 {
	...
	public void glGetFramebufferAttachmentParameteriv (int target, int attachment, int pname, IntBuffer params) {
		...
		case GL20.GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME:
			...
			return;
		default:
			throw new ArcRuntimeException("glGetFramebufferAttachmentParameteriv Invalid enum for WebGL backend.");
		}
	}
	...
	public void glTexImage2D (int target, int level, int internalformat, int width, int height, int border, int format, int type,
		...
		if (pixels == null) {
			...
			if (pixels instanceof FloatBuffer) {
				...
				throw new ArcRuntimeException("Unsupported Buffer type");
			}
		}
	}
